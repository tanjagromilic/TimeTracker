...
using TimeTrackerPMF.Client.Models;

namespace TimeTrackerPMF.Client.Security
{
    public class TokenAuthenticationStateProvider:AuthenticationStateProvider 
    {
        ...
        private static IEnumerable<Claim> GetClaimsFromTokenAndUser(string token, UserModel user)
        {
